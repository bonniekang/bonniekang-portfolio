            ...
            <div className="wrapper">
                ...
                <div className="projects">
                    <div className="project">
                        ...
                        <div className="img-container"><img src="assets/guild-1.png" alt=""/></div>
                    </div>
                    ...
                    <div className="project">
                        ...
                        <div className="img-container"><img src="assets/groundbnb-1.png" alt=""/></div>
                    </div>
                    ...
                    <div className="project">
                        ...
                        <div className="img-container"><img src="assets/movie-1.png" alt=""/></div>
                    </div>
                </div>
            </div>
        </div>
